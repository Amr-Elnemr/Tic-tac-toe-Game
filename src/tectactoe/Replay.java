...
public  class Replay extends Pane {
   ...
   String player2;
    ...
    public Replay(Stage MyStage,int []moves,String p1,String p2,String GameResult) {
            ...
            for(int pos: movesArray){
                ...
                if(Integer.valueOf(pos).equals(-1)){
                    ...
                    final KeyFrame kf = new KeyFrame(Duration.seconds(delay), e -> {
                        tempo[pos-1].setStyle("-fx-font-size:40; -fx-text-fill:#3080e8 ;-fx-background-color:#e4e4e4 ");  
                    ...
                    final KeyFrame kf = new KeyFrame(Duration.seconds(delay), e -> {
                        tempo[pos-1].setStyle("-fx-font-size:40; -fx-text-fill:#F8649E;-fx-background-color:#e4e4e4");  
