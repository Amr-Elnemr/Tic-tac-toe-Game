...
///*** [This fucntion will return true if the player has games, else will return false] ***///
    public Boolean hasGames(int playerId){
        try {
            PreparedStatement pst=con.prepareStatement("SELECT * FROM Games WHERE P1_ID= ?");
