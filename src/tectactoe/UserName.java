...
public class UserName extends Pane {
            ...
            if(textField.getText().trim().isEmpty())
               {
                ...
                else
                {
                    ...
                    try{
                        ...
                        //check if user Existand have games to replay them
                        
                         if(db.searchNames(textField.getText()))
                          {
                               if(db.hasGames(db.getPlayerID(textField.getText())))
                               {
                                       UserGames viewroot=new UserGames(MyStage,textField.getText());
                                       Scene scene = new Scene(viewroot, 500, 400);
                               ...
                               }else
                               {
                                    ...
                                    alert.setTitle("Information Dialog");
                                    alert.setHeaderText("Information Help Dialog");
                                    alert.setContentText(" This player doesnot have any Games \n ");
                                    alert.showAndWait();
                          ...
                          }else
                          {
                                ...
                                alert.setTitle("Information Dialog");
                                alert.setHeaderText("Information Help Dialog");
                                alert.setContentText(" This player doesnot exist \n ,Enter a different player name ");
                                alert.showAndWait();
